...
exports.approveContent = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
exports.approveContent = functions.region('asia-northeast3').https.onCall(async (data, context) => {
    var _a, _b, _c;
    if (!context.auth) {
    ...
    try {
        ...
        if (allApproved && appsSnap.size > 0) {
            ...
            const paybackPrice = ((_b = campaignSnap.data()) === null || _b === void 0 ? void 0 : _b.paybackPrice) || 0;
            if (paybackPrice > 0) {
                for (const docSnap of appsSnap.docs) {
                    ...
                    batch.set(txRef, {
                        ...
                        campaignName: ((_c = campaignSnap.data()) === null || _c === void 0 ? void 0 : _c.name) || 'campaign',
                        description: 'reward',
...
//# sourceMappingURL=approveContent.js.map