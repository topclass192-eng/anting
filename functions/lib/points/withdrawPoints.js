...
exports.withdrawPoints = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
exports.withdrawPoints = functions.region('asia-northeast3').https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        const result = await db.runTransaction(async (transaction) => {
            ...
            const currentPoints = ((_a = influencerDoc.data()) === null || _a === void 0 ? void 0 : _a.points) || 0;
...
//# sourceMappingURL=withdrawPoints.js.map